...
def process_subject_file(path: str):
    ...
    final_df = final_df[['SubjectID', 'Block', 'Trial', 'Procedure', 'Condition', 'Target.ACC', 'Target.RT']]
    return final_df
...
def main():
    ...
    for fname in os.listdir(input_dir):
        if fname.startswith('Subject') and fname.endswith('.csv'):
            ...
            # ensure column order
            cleaned = cleaned[['SubjectID', 'Block', 'Trial', 'Procedure', 'Condition', 'Target.ACC', 'Target.RT']]
