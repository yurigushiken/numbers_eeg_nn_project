...
HAPPE_SET_DIR = os.path.join(BASE_INPUT_DIR, "5 - processed (45hz)")
HAPPE_USABLE_TRIALS_FILE = os.path.join(BASE_INPUT_DIR, "6 - quality_assessment_outputs (45hz)", "HAPPE_dataQC_20-08-2025.csv")

# --- DYNAMIC OUTPUT PATH ---
if PROCESS_ACC_ONLY:
    output_dir = os.path.join(BASE_OUTPUT_DIR, "acc_1_dataset (45hz) V2") 
else:
    output_dir = os.path.join(BASE_OUTPUT_DIR, "all_trials_dataset (45hz) V2")
