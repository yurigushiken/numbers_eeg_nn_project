"""Landing-digit decoding for small numbers (1, 2, 3).
...
stimulus was one of the small numbers.
"""
...
def label_fn(meta: pd.DataFrame):
    """
    Return landing digit (1, 2, or 3) from the Condition code, explicitly
    including only trials where the landing digit is 1, 2, or 3.
    """
