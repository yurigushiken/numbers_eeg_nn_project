"""Parity-transition decoding task.
...
def label_fn(meta: pd.DataFrame):
    ...
    labels.loc[valid_trials & ~is_prime_even & is_stim_even] = "odd_to_even"
    labels.loc[valid_trials & is_prime_even & ~is_stim_even] = "even_to_odd"
